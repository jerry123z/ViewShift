...
public class VideoPlayer : PlayerMover
{
    ...
    void Update()
    {
        ...
        _inputs += Input.GetAxis("Horizontal") * Vector3.Cross(-1 * Vector3.up, offset * cam.GetComponent<VideoCamera>().orientation);
        _inputs += Input.GetAxis("Vertical") * -1 * (offset * cam.GetComponent<VideoCamera>().orientation);
